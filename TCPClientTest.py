...
if __name__ == "__main__":
    jetson_ip = "192.168.113.127"  # Replace with your Jetson's IP address
    command = "move forward"
    send_command_to_jetson(command, jetson_ip)


""" new IP at EBU: 192.168.10.245
If we want to send it using bash echo command: echo "1,0.5,5,0" | nc 192.168.10.245 5005
